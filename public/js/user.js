...
deconnecter.addEventListener("click",function(e){
	e.preventDefault()
	fetch("http://localhost:4000/deconnect/"+localStorage.getItem("iduserconnecte")).then(function(reponse){
	return reponse.json()
...
fetch("http://localhost:4000/disponible").then(function(reponse){
	return reponse.json()
}).then(function(disponible){
